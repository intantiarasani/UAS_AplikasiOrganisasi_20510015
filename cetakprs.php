...
<style>
        ...
        <main>
    	<h2 class="text-center mt-2">Data Pengurus</h2>
					...
					<?php
						$no = 1;
                         foreach ($organisasi as $organisasi){
                            ...
                            <tr>
                                <td> <?php echo $no;  ?> </td>
								<td> <?php echo $organisasi->nama;  ?> </td>
                                <td> <?php echo $organisasi->divisi;  ?> </td>
                                <td> <?php echo $organisasi->email;  ?> </td>
                                <td> <?php echo $organisasi->angkatan;  ?> </td>
